...
public partial class Affet : ContentPage
{
    ...
    private async void LoadBilgi()
    {
        ...
        main = new ObservableCollection<SarkıM>(music.Where(x => x.SarkıAd.Contains("Affet")));
    ...
    {
        var audioFile = await FileSystem.OpenAppPackageFileAsync("Sound/affet2.mp3");
