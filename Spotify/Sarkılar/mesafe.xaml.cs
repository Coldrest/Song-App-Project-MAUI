...
public partial class mesafe : ContentPage
{
    ...
    private async void LoadBilgi()
    {
        ...
        main = new ObservableCollection<SarkıM>(music.Where(x=>x.SarkıAd.Contains("Mesafe")));
    ...
    {
        var audioFile = await FileSystem.OpenAppPackageFileAsync("Sound/mesafe2.mp3");
