...
public partial class LoversRock : ContentPage
{
    ...
    private async void LoadBilgi()
    {
        ...
        main = new ObservableCollection<SarkıM>(music.Where(x => x.SarkıAd.Contains("Lovers Rock")));
    ...
    {
        var audioFile = await FileSystem.OpenAppPackageFileAsync("Sound/loversrock2.mp3");
