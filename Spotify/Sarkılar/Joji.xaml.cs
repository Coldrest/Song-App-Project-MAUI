...
public partial class Joji : ContentPage
{
    ...
    private async void LoadBilgi()
    {
        ...
        main = new ObservableCollection<SarkıM>(music.Where(x => x.SarkıAd.Contains("Gimme Love")));
    ...
    {
        var audioFile = await FileSystem.OpenAppPackageFileAsync("Sound/joji2.mp3");
