...
public partial class NKBİ : ContentPage
{
    ...
    private async void LoadBilgi()
    {
        ...
        main = new ObservableCollection<SarkıM>(music.Where(x => x.SarkıAd.Contains("NKBİ")));
    ...
    {
        var audioFile = await FileSystem.OpenAppPackageFileAsync("Sound/nkbi2.mp3");
