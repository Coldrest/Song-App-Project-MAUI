...
public partial class Askinolayim: ContentPage
{
    ...
    private async void LoadBilgi()
    {
        ...
        main = new ObservableCollection<SarkıM>(music.Where(x => x.SarkıAd.Contains("Aşkın Olayım")));
    ...
    {
        var audioFile = await FileSystem.OpenAppPackageFileAsync("Sound/askinolayim2.mp3");
